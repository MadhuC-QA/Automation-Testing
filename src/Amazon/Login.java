...
public class Login {
	...
	public static void main(String[] args) {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Redmi Note 13 Pro (Midnight Black, 8GB RAM, 128GB Storage) | 1.5K AMOLED | 200MP Hi-Res Camera | Flagship 4nm SD 7s Gen 2 | 67W TurboCharge")));
